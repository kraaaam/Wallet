# Generated by Django 4.2.11 on 2024-04-11 03:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_type', models.CharField(choices=[('topup', 'Topup'), ('charge', 'Charge'), ('transfer_add', 'Transfer Add'), ('transfer_deduct', 'Transfer Deduct'), ('refund', 'Refund')], max_length=20)),
                ('previous_balance', models.BigIntegerField(default=0)),
                ('current_balance', models.BigIntegerField(default=0)),
                ('wallet_obj', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='transactions', to='core.wallet')),
            ],
            bases=('core.basemodel',),
        ),
    ]
